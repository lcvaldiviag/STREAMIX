...
export const PRODUCTS: Product[] = [
  ...
  { id: 'prod-16', name: 'Canva Pro + curso', category: Category.EDUCATION_LEARNING, priceUSD: 1.00, priceBS: 10, logo: "CP", brandColor: '#8E44AD', description: 'Licencia PRO x 30 días + el curso. Incluye acceso vitalicio vía DRIVE a tu correo personal.' },
  { id: 'prod-17', name: 'CapCut Pro + curso', category: Category.EDUCATION_LEARNING, priceUSD: 2.50, priceBS: 25, logo: "CC", brandColor: '#00D68F', description: 'Licencia CapCut PRO x 30 días + el curso. Acceso vitalicio vía DRIVE.' },
