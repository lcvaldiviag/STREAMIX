...
export const PRODUCTS: Product[] = [
  ...
  { id: 'prod-08', name: 'Crunchyroll Mega Fan', category: Category.STREAMING_SERIES, priceUSD: 3.00, priceBS: 30, logo: "C", brandColor: '#F47521', description: 'Anime sin anuncios, nuevos episodios tras Japón y lectura de manga ilimitada.' },
  ...
  { id: 'prod-gemini', name: 'Gemini (AI)', category: Category.AI, priceUSD: 5.00, priceBS: 50, logo: "Ge", brandColor: '#4285F4', description: 'El modelo multimodal más capaz de Google. Razonamiento, código y colaboración creativa.' },
  { id: 'prod-bing', name: 'Bing AI Pro', category: Category.AI, priceUSD: 3.00, priceBS: 30, logo: "Bi", brandColor: '#0078D4', description: 'Búsqueda conversacional y creación de contenido impulsada por la tecnología de OpenAI.' },
