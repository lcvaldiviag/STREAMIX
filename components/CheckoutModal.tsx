            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md flex flex-col max-h-[95vh]">
                ...
                <main className="p-6 text-center overflow-y-auto">
                    ...
                    <div className="flex justify-center mb-4">
                        <img src={QR_CODE_URL} alt="Código QR de pago" className="w-48 h-48 border rounded-xl" />
                    </div>

                    <div className="text-sm text-left text-gray-700 my-4 p-3 bg-blue-50 rounded-xl border border-blue-200">
                        <p className="font-semibold text-blue-800">Otros métodos de pago</p>
                        <p className="mt-1">
                    ...
                    <div className="text-left bg-gray-50 p-3 rounded-xl mb-4">
                     ...
                     <p className="text-sm text-gray-500 mb-4">Después de pagar, por favor envíanos el recibo vía WhatsApp para activar tus productos.</p>
                     <a
                        href={whatsappUrl}
                        target="_blank"
                 ...
                 <footer className="p-4 text-center text-xs text-gray-400 border-t flex-shrink-0">
